public class Crater
{
    ...
    public bool IsInside(Crater crater)
    {
        double distance = Math.Sqrt(Math.Pow(this.xCord - crater.xCord, 2) + Math.Pow(this.yCord - crater.yCord, 2));
        return distance < (this.radius - crater.radius) ? true : false;
    }
}